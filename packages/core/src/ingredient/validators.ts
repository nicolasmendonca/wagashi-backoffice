...
export const validateCreateIngredient: Validator<Ingredient> = async (ingredientList: IngredientWithId[], ingredient: Ingredient) => {
...
const validateIngredientHasName: Validator<Ingredient> = async (ingredient: Ingredient) => {
  if (!ingredient.name) {
...
const validateIngredientNameIsUnique: Validator<Ingredient> = async (ingredientList: IngredientWithId[], ingredient) => {
...
export const validateIngredientExists: Validator<Ingredient> = async (ingredientList: IngredientWithId[], ingredientId: string) => {
