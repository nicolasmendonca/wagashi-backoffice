...
export const validateCreateRecipe = async (loadIngredientsService: LoadIngredientsService, recipe: Recipe) => {
...
export const validateUpdateRecipe = async (loadIngredientsService: LoadIngredientsService, recipe: Recipe) => {
  let validatedRecipe = recipe;
  validatedRecipe = await validateRecipeHasName(recipe);
  validatedRecipe = await validateRecipeContainsIngredients(recipe);
...
const validateRecipeContainsIngredients = async (recipe: Recipe) => {
...
const validateIngredientsExist = async (ingredientList: IngredientWithId[], recipe: Recipe) => {
